package cn.tedu.csmall.stock.adapter.service.impl;
...
import cn.tedu.csmall.stock.adapter.mapper.StockMapper;
...
public class StockServiceImpl implements IStockService {
    ...
    public void reduceCommodityCount(StockReduceCountDTO stockReduceCountDTO) {
        ...
        if (count==0){
            throw new CoolSharkServiceException(ResponseCode.BAD_REQUEST,"库存不存在");
        }
        // 调用减少库存的持久层方法
